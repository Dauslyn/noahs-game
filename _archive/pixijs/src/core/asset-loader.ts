...
const TEXTURE_MANIFEST: Record<string, string> = {
  ...
  // Noah character (PixelLab, 40x40 side-view)
  'noah-east': '/assets/sprites/noah/noah-east.png',
  'noah-west': '/assets/sprites/noah/noah-west.png',

  // B3ANS mech companion (PixelLab v3, 40x40 side-view)
  'beans-east': '/assets/sprites/beans/beans-east.png',
  'beans-west': '/assets/sprites/beans/beans-west.png',

  // Haven biome parallax backgrounds
  'bg-haven-sky': '/assets/backgrounds/haven-sky.png',
  'bg-haven-structures': '/assets/backgrounds/haven-structures.png',
